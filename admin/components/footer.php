...
var shortDescriptionEl = document.querySelector('#short_description');
if (shortDescriptionEl) {
    ClassicEditor
        .create(shortDescriptionEl)
        .catch(function (error) {
            console.error(error);
        });
}

var productDetailsEl = document.querySelector('#product_details');
if (productDetailsEl) {
    ClassicEditor
        .create(productDetailsEl)
        .catch(function (error) {
            console.error(error);
        });
}
