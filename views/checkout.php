...
<?php
$hero_kicker = 'Thanh toán';
$hero_title = 'Hoàn tất đơn hàng';
$hero_desc = 'Xác nhận thông tin giao hàng và phương thức thanh toán.';
$hero_modifier = 'coffee-page-hero--checkout';
include __DIR__ . '/../components/coffee-page-hero.php';
?>

<!-- Checkout Section Begin -->
<section class="checkout spad coffee-checkout-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h6 class="coupon__link"><span class="icon_tag_alt mr-1"></span>Tiến hành thanh toán đơn hàng <a
                        class="text-primary" href="index.php?url=gio-hang">Trở lại giỏ hàng</a> </h6>
            </div>
        </div>
