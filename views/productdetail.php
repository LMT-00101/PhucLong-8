...
<?php
$hero_kicker = 'Chi tiết sản phẩm';
$hero_title = $name ?? 'Sản phẩm';
$hero_desc = 'Thông tin đầy đủ, hương vị tươi mát — đặt ngay chỉ với vài thao tác.';
$hero_modifier = 'coffee-page-hero--product';
include __DIR__ . '/../components/coffee-page-hero.php';
?>

<!-- Product Details Section Begin -->
<section class="product-details spad coffee-product-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                    ...
                    <div class="product__details__button">
                        ...
                        <form class="js-add-to-cart-form" method="post" action="#">
                            ...
                            <div class="quantity">
                                ...
                                <button name="add_to_cart" style="border: none;" type="submit"
                                    ...
                                    giỏ</button>
                                <button name="add_to_cart" type="submit" data-buy-now="1"
                        ...
                        <div class="quantity">
                            <button name="add_to_cart" onclick="alert('Vui lòng dăng nhập để thực hiện chức năng');"
                                ...
                                <span class="icon_bag_alt"></span> <a href="index.php?url=dang-nhap" style="color: #ffffff;">Thêm vào
                                    giỏ</a>
                            </button>
                            <button name="add_to_cart" onclick="alert('Vui lòng dăng nhập để thực hiện chức năng');"
                                type="submit" style="background-color: #ca1515; border: none;" class="cart-btn">
                                <span class="icon_bag_alt"></span> <a href="index.php?url=dang-nhap" style="color: #ffffff;">Mua
                                    ngay</a>
                            </button>
                        </div>
                        <?php }?>
                        ...
                        <ul class="product__hover">
                            ...
                            <li>
                                <form class="js-add-to-cart-form" method="post" action="#">
                                    ...
                                    <button type="submit" name="add_to_cart" aria-label="Thêm vào giỏ">
