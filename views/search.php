...
<div class="breadcrumb-option">
    ...
    <?php
    $hero_kicker = 'Tìm kiếm nhanh';
    $hero_title = 'Kết quả tìm kiếm';
    $hero_desc = 'Tìm món yêu thích theo tên hoặc khoảng giá phù hợp với bạn.';
    $hero_modifier = 'coffee-page-hero--search';
